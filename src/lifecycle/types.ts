...
// A1); until that lands, pinta-codex vendors an identical copy (same as
// pinta-cc's A2/A3) so the M5a scanner has a contract to implement against.
// Do NOT diverge from the plan's shape here — when @pinta-ai/core@^0.4.0 is
// available, this file is deleted and imports are repointed.
